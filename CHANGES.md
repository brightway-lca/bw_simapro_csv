...
* Fix [#33 - 'Non material emission' (singular) is not in BLOCK_MAPPING, causing IndexError in GenericBiosphere](https://github.com/brightway-lca/bw_simapro_csv/issues/33)
